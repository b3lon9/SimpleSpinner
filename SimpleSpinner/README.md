...
- 리스트 아이템 text 크기, 색상 설정 : (2023.03.30)
- 리스트 아이템 배경 색상 설정 : (2023.04.04)
- 리스트 아이템 Divider 경계선 색상 : (2023.04.06) color → height
- 리스트 아이템 Divider 경계선 크기 : (2023.04.04)
- 리스트 아이템 Divider 표출 여부 : (2023.04.04)
- 리스트 아이템 터치시 사용할 색상적용 :  (2023.04.08)
